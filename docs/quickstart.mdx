---
title: "AuditGuard quickstart: install your first skill"
description: Install your first AuditGuard skill and run a complete security testing methodology against a target in under two minutes — no prior setup required.
---
