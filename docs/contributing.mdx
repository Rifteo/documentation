---
title: Contributing skills and docs to AuditGuard
description: How to contribute a new skill, propose a context, or improve existing AuditGuard documentation, including style rules, review process, and submission steps.
---
...
<Steps>
  ...
  <Step title="Add to docs.json">
    Add your skill page to the appropriate group in `docs.json` under the Skills tab. Place it in the group that matches the skill category (Vulnerability Testing, Reporting, Recon, etc.):
    ```json
    {
      "group": "Vulnerability Testing",
      "pages": [
