---
title: Find
description: Discover and install specialized AuditGuard skills from the community ecosystem when users need extended audit capabilities.
---
...
```bash
npx skills add https://github.com/your-org/auditguard --skill find-skills
```
...
<CardGroup cols={3}>
  <Card title="skill-creator" href="/skills/skill-template">
    Create, test, and publish new AuditGuard skills from within your workflow

    `your-org/auditguard`
  </Card>
  <Card title="check-access-control" href="/skills/skill-template">
    Verify IAM policies, roles, and least-privilege enforcement

    `your-org/auditguard`
  </Card>
  <Card title="validate-audit-logs" href="/skills/skill-template">
    Confirm audit logging is enabled and correctly configured
