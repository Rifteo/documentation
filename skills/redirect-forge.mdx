...
description: "Open redirect detection and exploitation methodology: parameter discovery, 30+ bypass techniques, OAuth token theft, SSRF chaining, and phishing escalation."
---
...
```bash
auditguard-skills add redirect-forge
```
