---
title: HPP Hunter
description: "HTTP Parameter Pollution methodology: server fingerprinting, server- and client-side HPP, WAF bypass via parameter splitting, header and JSON body pollution."
---
...
```bash
auditguard-skills add hpp-hunter
```
