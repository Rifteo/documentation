---
title: CVSS Scorer
description: Compute an exact CVSS v3.1 base score and vector from a vulnerability description — infers metrics from context and asks only when severity is ambiguous.
---
