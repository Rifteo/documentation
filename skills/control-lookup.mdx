...
description: Look up any control ID across ISO 27001, NIST CSF, PCI-DSS v4, and OWASP — returns the full control card, cross-framework mappings, and testing hints.
---
