---
title: SSRF Hunter
description: "SSRF detection and exploitation methodology: injection points, cloud metadata theft on AWS/GCP/Azure, internal enumeration, protocol abuse, and blind SSRF."
---
