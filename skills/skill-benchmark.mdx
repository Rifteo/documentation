...
Check the skill against each of the 7 agent profiles for hard-fail and soft-fail signals. Assign the worst result across all applicable profiles per named agent (❌ overrides ⚠️ overrides ✅).
