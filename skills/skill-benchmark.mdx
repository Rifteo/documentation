...
description: Score any SKILL.md across 5 quality dimensions, run a compatibility check against 50+ AI agents, and return a ranked fix list to improve adoption.
---
