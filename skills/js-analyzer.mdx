---
title: JS Analyzer
description: "JavaScript analysis methodology for pentesting: JS file discovery, secret extraction, endpoint mapping, DOM XSS, prototype pollution, and source map recovery."
---
...
```bash
auditguard-skills add js-analyzer
```
