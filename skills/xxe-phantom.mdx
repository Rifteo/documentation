---
title: XXE Phantom
description: "XXE methodology: classic file read, blind OOB exfiltration, XInclude, SVG/DOCX/SAML vectors, WAF bypass, SSRF chaining, and finding report structure."
---
...
```bash
auditguard-skills add xxe-phantom
```
