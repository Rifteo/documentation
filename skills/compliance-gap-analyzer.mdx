...
description: Aggregate audit findings against ISO 27001, NIST CSF, PCI-DSS, and OWASP controls, classify gaps by severity, and produce a complete compliance gap report.
---
