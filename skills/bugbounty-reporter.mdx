...
description: Convert raw bug bounty findings into a triage-ready report with a clear description, numbered reproduction steps, self-contained PoC, risk, and remediation.
---
