---
title: Scope Grill
description: Interview the user about a pentest or audit engagement before testing — capture target, scope, rules of engagement, auth, and deliverables into a brief.
---
