---
title: Risk Assessor
description: Score a vulnerability using likelihood × impact, CIA triad analysis, CVSS correlation, and SLA-bound remediation urgency to produce a defensible risk rating.
---
