...
description: Convert a vulnerability description or HTTP request/response pair into a ready-to-run Nuclei YAML template with auth handling, matchers, and OOB detection.
---
