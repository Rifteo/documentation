...
description: Map every entry point, component, and trust boundary of a target before testing — prevents missed coverage and prioritizes the highest-value attack paths.
---
...
```bash
auditguard-skills add attack-surface
```
