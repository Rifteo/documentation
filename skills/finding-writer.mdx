...
description: Convert raw pentest notes, logs, or observations into a structured audit finding with title, impact, evidence, and remediation ready for a security report.
---

<Info>
  **Category:** Pentest & reporting
</Info>
