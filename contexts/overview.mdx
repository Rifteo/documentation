...
See [CONTEXT_GUIDE.md](https://github.com/Rifteo-Community/context-mcp/blob/main/CONTEXT_GUIDE.md) for the full format reference including optional fields.
...
Ready to write a context? Follow the [CONTEXT_GUIDE.md](https://github.com/Rifteo-Community/context-mcp/blob/main/CONTEXT_GUIDE.md) in the community repo.
