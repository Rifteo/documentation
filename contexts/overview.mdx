...
| [AD Pentest (Unauthenticated)](/contexts/ad-pentest-unauthenticated) | Unauthenticated infra pentest with AD focus, host discovery, SMB null sessions, AS-REP roasting, Kerberoasting | Pentest |
| [Cloud Audit](/contexts/cloud-audit) | AWS, Azure, and GCP security, IAM, storage exposure, networking, secrets, and logging | Audit |
| [Code Audit](/contexts/code-audit) | Source code review across quality, architecture, maintainability, and security with STRIDE threat modeling | Audit |
