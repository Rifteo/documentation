---
title: Cloud Audit
description: Security audit methodology for AWS, Azure, and GCP environments covering IAM, storage exposure, network controls, secrets management, and logging gaps.
---
