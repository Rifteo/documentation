...
description: Security review methodology for REST and GraphQL APIs covering authentication, authorization, BOLA/IDOR, input validation, rate limiting, and abuse cases.
---
...
```
get the api-security-review context
```
